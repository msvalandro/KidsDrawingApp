...
**Kids Drawing App** is an Android mobile application built using Kotlin and XML Layout. This is a simple drawing app using Android canvas to learn its concepts.
...
1. Clone the repository:
    ```sh
    git clone https://github.com/msvalandro/KidsDrawingApp.git
    cd KidsDrawingApp
    ```
